...
async function main() {
  ...
  // 1. English Profile (Default for international evaluation)
  ...
  // 2. Russian Profile (For local market & personal use)
  await prisma.profile.create({
    data: {
      locale: 'ru',
  ...
  console.log('Seeding completed successfully! Both EN and RU profiles created.');
}
